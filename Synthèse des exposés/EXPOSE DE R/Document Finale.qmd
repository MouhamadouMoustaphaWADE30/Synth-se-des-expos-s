...
![Une image](cover.png){fig-align="center"}
...
Par exemple. Je m'appelle LABOU [^document-finale-1]Komla Alex.

[^document-finale-1]: Nom d'une tribu au Sud du Togo
...
L'Afrique est un contient très sous développé [@lasida2009].
